...
<?php global $user ?>
            ...
            <form method="post" action="assets/php/actions.php?updateprofile" enctype="multipart/form-data">
                ...
                <div >
                    ...
                    <div >
                        <input  <?=$user['gender']==2?"checked":""?> disabled type="radio" name="exampleRadios" id="exampleRadios3"
                            value="option2">
                    ...
                    <div >
                        <input  <?=$user['gender']==0?"checked":""?>  disabled  type="radio" name="exampleRadios" id="exampleRadios2"
                            value="option2">
